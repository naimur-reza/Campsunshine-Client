...
const Sidebar = () => {
  ...
  return (
    <>
      ...
      <aside
        className={`z-10 lg:dark:bg-black/50 dark:bg-black  md:fixed flex flex-col  overflow-x-hidden scroll-smooth  hide-scrollbar w-64 space-y-6 px-2 py-4 absolute inset-y-0 left-0 transform ${
