...
const Sidebar = () => {
  ...
  return (
    <>
      ...
      <aside
        className={`z-10 dark:bg-black/50 md:fixed flex flex-col  overflow-x-hidden  border-r border-gray-300 w-64 space-y-6 px-2 py-4 absolute inset-y-0 left-0 transform ${
